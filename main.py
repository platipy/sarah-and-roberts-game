...
def main():
    ...
    color_selector = 0
    color_inc = random.randint(0, 256) + 256**2 + random.randint(0, 256) + 256 + random.randint(0, 256)
    drawing = True
            ...
            if event.type == pygame.MOUSEMOTION and drawing:
                if pygame.key.get_mods() & pygame.KMOD_LCTRL:
                    ...
                    if color_scheme == "random":
                        ...
                        color = (color_selector % (256**3) >> 16, color_selector % (256**2) >> 8, color_selector % 256)
